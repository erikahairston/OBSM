<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST")
    {
        ...
        {
            apologize("You must provide a title for your annoucement or event.");
        }
       ...
       //if they are adding an img, add imgurl into database
        ...
        else if($vid==1)
        {
            ...
            //if they did not add an img or a vid
              ...
              // insert the content to database
            CS50::query("INSERT INTO upload (user_id, firstname, school, title, category, description) VALUES(?, ?, ?, ?, ?, ?)",
                $_SESSION["id"], $firstname, $school, $_POST["title"], $category, $_POST["description"]);
        ...
        // else render form
        render("addevent_form.php", ["title" => "Annoucement"]);
    }
